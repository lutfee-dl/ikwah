...
export default function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-40 bg-white/80 backdrop-blur-md px-5 py-4 flex justify-between items-center border-b border-slate-100 transition-all ${
        pathname === "/dashboard/profile" ? "opacity-0 -translate-y-full pointer-events-none" : ""
      }`}
    >
